...
int main() {
	...
	sDate Date_2 = ReadDate();

	cout << "\n\n";
	cout << "The difference in days between the two dates is: " << GetDifferenceInDays(Date_1, Date_2) << endl;
	cout << "The difference in days between the two dates (including the end day) is: " << GetDifferenceInDays(Date_1, Date_2, true) << endl;
